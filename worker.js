...
const BOT_TOKEN = "7618077253:AAFgMttEwWGhdxqqjYxBLJDWCNa_IYkgylQ"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "BOT_SECRET"; // Insert a powerful secret text.
const BOT_OWNER = 819861991; // Insert your telegram account id.
const BOT_CHANNEL = -1001916142483; // Insert your telegram channel id which the bot is admin in.
const SIA_NUMBER = 14327; // Insert a random integer number and keep it safe.
